                    ...
                    <div class="card-body">
                      ...
                      <form class="forms-sample">
                        ...
                        <div class="form-group{{ $errors->has('id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="id" type="number" class="form-control" name="id" value="{{ $data->id}}" maxlength="8" readonly>
                                @if ($errors->has('id'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('level') ? ' has-error' : '' }}">
                            <label for="level" class="col-md-4 control-label">cek status</label>
                            <div class="col-md-6">
                            <select class="form-control" name="cs" required="" disabled="">
                                <option value=""></option>
                                <option value="Y" {{$data->cs === "Y" ? "selected" : ""}}>aktif</option>
                                <option value="N" {{$data->cs === "N" ? "selected" : ""}}>nonaktif</option>
                            </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('posisi') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                            <select class="form-control" name="posisi" required="" disabled="">
                                <option value=""></option>
                                <option value="PG" {{$data->posisi === "PG" ? "selected" : ""}} >Pengepul</option>
                                <option value="PL" {{$data->posisi === "PL" ? "selected" : ""}} >Pengumpul</option>
                            </select>
                            </div>
                        </div>
